...
### No telemetry
- Zero network calls from veil itself: no update checks, no analytics, no
  phone-home. License validation (Pro) is fully offline.
...
offline. See the project website for how to obtain a license.
